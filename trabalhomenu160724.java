...
public class trabalhomenu160724 extends JFrame 
{
   ...
   public trabalhomenu160724()
   {
      super("Tabalho de Menus");     
      ...
      aboutItem.addActionListener(
         ...
         {  
            ...
            {
               JOptionPane.showMessageDialog(trabalhomenu160724.this,
                  "Esse é um exemplo\nde como se usar menus.",
      ...
      formatMenu.setMnemonic('E'); // set mnemonic to r

      // array listing string colors
      String[] colors = {"Preto", "Azul", "Vermelho", "Verde"};

      JMenu colorMenu = new JMenu("Cor"); // create color menu
      ...
      String[] styleNames = {"Negrito", "Italico"}; // names of styles
